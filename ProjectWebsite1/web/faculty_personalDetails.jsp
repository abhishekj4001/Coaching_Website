...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i>Personal Details</a>
  <ul>
      ...
      <li class="active"> <a href="faculty_personalDetails.jsp"><i class="icon icon-signal"></i> <span>Personal Details</span></a> </li>
...
<div id="content">
  <div id="content-header">
      <div id="breadcrumb"><a href="faculty_index_2.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Profile</a></div>
    <h1>Personal Details</h1>
        ...
        <div class="wrapper--w680">
            ...
            <div class="">
                <div class="card-body"> 
           <form action="facultyImage.do" method="post" enctype="multipart/form-data">
...
<h6 style="padding-left:40px;">*Insert passport size image only!</h6>
 ...
 <form action="faculty_personaldetails_logic.jsp" method="post"> 
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="name1" type="text" name="faculty_name"
                                           value="<%=rtst.getString(1)%>" disabled>
                                </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class=""><h5>Designation</h5></label>
                                    <input class="input--style-4" id="name2" type="text" name="designation"
                                           value="<%=rtst.getString(2)%>" disabled>
                                </div>
                            </div>
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="name3" value="<%=rtst.getString(3)%>" disabled type="text" name="department">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="name4" value="<%=rtst.getLong(4)%>" disabled type="text" name="contact">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="name5" value="<%=rtst.getString(5)%>" disabled type="text" name="email">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="name6" value="<%=rtst.getString(6)%>" disabled type="text" name="permanent">
                                </div>
                            </div>
