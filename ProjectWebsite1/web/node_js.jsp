<%-- 
    Document   : node_js
    Created on : 17 Oct, 2018, 11:27:45 PM
    Author     : Rini
--%>
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
	                                <div class="jq-tab-content active" data-tab="1">
                                              ...
                                              <h4><b>Introduction to Node JS</b></h4><br>
                                <li>What is Node JS?</li>
                                <li>Advantages of Node JS</li>
                                <li>Traditional Web Server Model</li>
                                <li>Node.js Process Model</li><br>

                                <h4><b>Setup Dev Environment</b></h4><br>
                                <li>Install Node.js on Windows</li>
                                <li>Installing in mac OS</li>
                                <li>Working in REPL</li>
                                <li>Node JS Console</li><br>

                                <h4><b>Node JS Modules</b></h4><br>
                                <li>Functions</li>
                                <li>Buffer</li>
                                <li>Module</li>
                                <li>Module Types</li>
                                <li>Core Modules</li>
                                <li>Local Modules</li>
                                <li>Module.Exports</li><br>

                                <h4><b>Node Package Manager</b></h4><br>
                                <li>What is NPM?</li>
                                <li>Installing Packages Locally</li>
                                <li>Adding dependency in package.json</li>
                                <li>Installing packages globally</li>
                                <li>Updating packages</li><br>

                                <h4><b>Creating Web Server</b></h4><br>
                                <li>Creating web server</li>
                                <li>Handling http requests</li>
                                <li>Sending requests</li><br>

                                <h4><b>File System</b></h4><br>
                                <li>Fs.readFile</li>
                                <li>Writing a File</li>
                                <li>Writing a File asynchronously</li>
                                <li>Opening a file</li>
                                <li>Deleting a file</li>
                                <li>Other IO Operations</li><br>

                                <h4><b>Debugging Node JS Application</b></h4><br>
                                <li>Core Node JS debug</li>
                                <li>Debugging with Visual Studio</li><br>

                                <h4><b>Events</b></h4><br>
                                <li>Event Emitter class</li>
                                <li>Returning event emitter</li>
                                <li>Inhering events</li><br>

                                <h4><b>Express.JS</b></h4><br>
                                <li>Configuring routes</li>
                                <li>Working with express</li><br>

                                <h4><b>Serving Static Resources</b></h4><br>
                                <li>Serving static files</li><br>

                                <h4><b>Database connectivity</b></h4><br>
                                <li>Connection String</li>
                                <li>Configuring</li>
                                <li>Working with select command</li>
                                <li>Updating records</li>
                                <li>Deleting records</li><br>

                                <h4><b>Template Engines</b></h4><br>
                                <li>Why Template Engine?</li>
                                <li>What is Jade?</li>
                                <li>What is Vash?</li><br>
                                        </div>
                                    </div><br>
                                                        </div>
                                                </div>
