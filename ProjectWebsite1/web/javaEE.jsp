<%-- 
    Document   : javaEE
    Created on : 17 Oct, 2018, 10:06:05 PM
    Author     : Rini
--%>
...
<!--	<section class="course-details-area pt-120">   -->
				<div class="container">
					<div class="row">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
	                                <div class="jq-tab-content active" data-tab="1">
                                           ...
                                           <h4><b>Introduction to Web</b></h4><br>
                        <li>HTML</li>
                        <li>JavaScript</li><br>

                        <h4><b>Introduction to J2EE</b></h4><br>
                        <li>What is J2EE?</li>
                        <li>What does J2EE comprise?</li><br>

                        <h4><b>Servlets</b></h4><br>
                        <li>Servlet terminology</li>
                        <li>Servlet API</li>
                        <li>Generic Servlet</li>
                        <li>Http Servlet</li>
                        <li>Servlet Life Cycle</li>
                        <li>Session Tracking in Servlets</li>
                        <li>Servlet Collaboration</li>
                        <li>JDBC in servlet</li>
                        <li>Servlet Pagination</li><br>

                        <h4><b>JSP</b></h4><br>
                        <li>JSP Introduction</li>
                        <li>JSP with Life cycle</li>
                        <li>JSP API</li>
                        ...
                        <li>JSTL</li>
                        <li>Custom tags</li>
                        <li>JSP pagination</li>
                        <li>JDBC in JSP</li>
                        <li>Development in JSP</li><br>

                        <h4><b>EJB (Enterprise JavaBeans)</b></h4><br>
                        <li>What is EJB?</li>
                        <li>What are the advantages of EJB?</li>
                        <li>Session Bean</li>
                        <li>What is Stateless Session Bean, its lifecycle and example.</li>
                        <li>What is Stateful Session Bean, its lifecycle and example.</li><br>

                        <h4><b>Spring</b></h4><br>
                        <li>Introduction to Spring</li><br><br>     
                                              </div>
                                    </div><br>
                                        </div>
                                                </div>
