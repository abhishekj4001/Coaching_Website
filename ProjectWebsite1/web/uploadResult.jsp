...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Attendance</a>
  <ul>
    ...
    <li class="active"><a href="uploadResult.jsp"><i class="icon icon-fullscreen"></i> <span>Upload Result</span></a></li>
...
<div id="content">
  <div id="content-header">
      <form action="result_logic.jsp" method="post"  > 
      <br><br>
     <h2> &nbsp; &nbsp;Upload Result</h2> 
     <br> <br>
     ...
     <h4>&nbsp; &nbsp;&nbsp; &nbsp;Mini-Marks</h4>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="text" name="mini"><br><br>
     <h4>&nbsp; &nbsp;&nbsp; &nbsp;Mid-Marks</h4>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="text" name="mid"><br><br>
    <h4>&nbsp; &nbsp;&nbsp; &nbsp;End-Term marks</h4>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="text" name="end"><br><br>
