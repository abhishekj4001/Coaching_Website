<%-- 
    Document   : contact
    Created on : Sep 6, 2018, 9:32:56 AM
    Author     : Rini
--%>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.jsp"> Contact Us</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-4 d-flex flex-column address-wrap">
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									<h5>Bhopal,India</h5>
									<p>
										JSTC E-3/285,10 No. Market, Near SBI Bank Bhopal
									</p>
								</div>
							</div>
							<div class="single-contact-address d-flex flex-row">
								...
								<div class="contact-details">
									<h5>0755-4269090, 9589016060</h5>
									<p>Mon to Fri 7:30am to 9 pm</p>
								</div>
							</div>
							<div class="single-contact-address d-flex flex-row">
								<div class="icon">
