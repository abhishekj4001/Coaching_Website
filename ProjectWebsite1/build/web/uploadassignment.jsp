...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Attendance</a>
  <ul>
    ...
    <li  class="active"><a href="uploadassignment.jsp"><i class="icon icon-fullscreen"></i> <span>Upload Assignments</span></a></li>
...
<div id="content">
  <div id="content-header">
      <form action="uploadpdf.do" method="post" enctype="multipart/form-data" > 
      <br><br>
     ...
     <h4>&nbsp; &nbsp;&nbsp; &nbsp;Choose File:</h4>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="file" name="pdf"><br><br>
