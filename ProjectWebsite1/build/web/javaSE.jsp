<%-- 
    Document   : javaSE.jsp
    Created on : 17 Oct, 2018, 10:05:47 PM
    Author     : Rini
--%>
				...
				<div class="container">
					<div class="row">
						...
						<!--	<div class="main-image">
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
	                                <div class="jq-tab-content active" data-tab="1">
                                                             ...
                                                             <h4><b>Basic Concepts</b></h4><br>
                            <li>Definition of Java</li>
                            <li>Features of Java</li>
                            <li>Installing JDK</li>
                            <li>Setting path in Java</li>
                            <li>Definition JDK,JRE,JVM</li>
                            <li>Data types and Operators</li>
                            <li>JShell</li><br>

                            <h4><b>Java OOPS Concept</b></h4><br>
                            <li>Features of OOPS & members of classes</li>
                            <li>Object and class</li>
                            <li>Static member with memory mapping</li>
                            <li>Loops & conditional statement</li>
                            <li>Non-Static Members & Constructors</li>
                            <li>Scanner Class</li>
                            <li>Array</li>
                            <li>Var-Arg</li>
                            <li>Inheritance</li>
                            ...
                            <li>Abstraction</li>
                            <li>Final keyword</li>
                            <li>Interface 7 and Interface 10</li>
                            <li>Lambda Expression</li>
                            <li>Wrapper class</li>
                            <li>Exception handling</li>
                            <li>Collection API</li>
                            <li>String Buffer and String Builder</li>
                            <li>File Handling</li>
                            <li>Thread</li>
                            <li>Swing(GUI)</li>
                            <li>JDBC</li><br><br>
