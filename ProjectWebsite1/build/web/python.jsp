<%-- 
    Document   : python.jsp
    Created on : 21 Jan, 2019, 6:29:00 PM
    Author     : Rini
--%>
		...
		<body>	
		    ...
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="index.jsp"><img src="" alt="" title="" /></a>
			      </div>
							...
							<div class="jq-tab-wrapper" id="horizontalTab">
	                            ...
	                            <div class="jq-tab-content-wrapper">
	                                <div class="jq-tab-content active" data-tab="1">
                                                             ...
                                                             <li> Unboxing And Setup </li>
                            <li>Flashing an SD card</li>
                            <li>Logging in for the first time</li>
                            <li>Introduction</li>
                            <li>GPIO Introduction</li>
                            <li>Python Introduction</li>
                            <li>Python Libraries</li>
                            <li>Electronic Components and uses</li>
                            <li>Blinking LED</li>
                            <li>List of Sensors</li>
                            <li>LED and Pushbuttons</li>
                            <li>Web Sockets</li>
                            <li>Relay Sensor with Bulb</li>
                            <li>Relay Sensor with pump motor</li>
                            <li>Distance Calculation of Objects using sensors</li>
                            <li>Connection between multiple sensors</li>
                            <li>Fire Protection System</li>
                            <li>Face Recognition using OpenCV</li>
                            <li>Difference between Controller and Processor</li>                       <br> <br> <br>
       </div>
                                    </div><br>
