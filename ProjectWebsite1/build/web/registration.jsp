...
<body>
  ...
  padding-bottom: 45px;"><b>Registration Form</b></h2>
                    <form action="Registration_logic.jsp" method="POST">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Name of Candidate</label>
                                    <input class="input--style-4" type="text" name="student_name">
                                </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="fathername">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="mothername">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Scholar No.</label>
                                    <input class="input--style-4" type="text" name="scholar">
                                </div>
                            </div>
                          ...
                          <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="semester">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="stud_contact" maxlength="10" minlength="10">
                                </div>
                            </div>
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="security" maxlength="10" minlength="10">
                                </div>
                            </div>
